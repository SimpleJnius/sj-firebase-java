...
- [ ] Choose a [LICENSE](https://github.com/SimpleJnius/sj-firebase-java/community/license/new?branch=main).
- [ ] Set your `ORG_GRADLE_PROJECT_NEXUS_USERNAME`, `ORG_GRADLE_PROJECT_NEXUS_PASSWORD`, `ORG_GRADLE_PROJECT_SIGNING_KEY` and `ORG_GRADLE_PROJECT_SIGNING_PWD` secrets in [Settings](https://github.com/SimpleJnius/sj-firebase-java/settings/secrets/actions).
